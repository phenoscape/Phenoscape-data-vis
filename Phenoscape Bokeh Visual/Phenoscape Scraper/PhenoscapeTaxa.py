...
uberonFile=['0002416','0003113','0001703','0011595','0005884','0005886','0011138','0001440','0001441','0012353','0007831','0007832']
i=0
uberonBaseNames = ['integumental system', 'dermatocranium', 'neurocranium', 'jaw region','hyoid arch skeleton', 'ventral hyoid arch skeleton', 'post-cranial axial skeletal system', 'forelimb skeleton', 'hindlimb skeleton', 'fin skeleton', 'pectoral girdle skeleton', 'pelvic girdle skeleton']; 

print len(uberonBaseNames)
print len(uberonFile)
for uberon in uberonFile:
    ...
    try:
        ...
        if ('total' in urlopen(phenoTotal).read() and 'label' in urlopen(name).read()):
            ...
            print str(num['total'])
            baseCase[uberonBaseNames[i]]=num['total'];
            i=i+1
